...
int main(int argc, char **argv) {
    ...
    active_3d_planning::ros::VoxgraphLocalPlanner::setupFactoryAndParams(&factory, &param_map, nh_private);

    // Create and launch the planner
    active_3d_planning::ros::VoxgraphLocalPlanner node(nh, nh_private, &factory, &param_map);
    node.planningLoop();
}
