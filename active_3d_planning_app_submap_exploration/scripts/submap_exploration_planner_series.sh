...
# *** Args (need to be set) ***
n_experiments=5
target_dir="/media/davide/DATA/data/submap_exploration_planner/Trail"		# Can reuse same dir to add experiments
...
do  
  # run experiment
  roslaunch active_3d_planning_app_submap_exploration submap_exploration_planner.launch data_directory:=$target_dir record_data:=true data_frequency:=$freq time_limit:=$dur
