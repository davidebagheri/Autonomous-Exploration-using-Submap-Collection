...
# *** Args (need to be set) ***
n_experiments=4
target_dir="/media/davide/DATA/data/naive_voxgraph_planner/WithDrift"		# Can reuse same dir to add experiments
...
do  
  ...
  roslaunch active_3d_planning_app_submap_exploration naive_voxgraph_exploration_planner.launch data_directory:=$target_dir record_data:=true data_frequency:=$freq time_limit:=$dur
