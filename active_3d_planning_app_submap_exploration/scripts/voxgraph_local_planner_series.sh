...
# *** Args (need to be set) ***
n_experiments=5
target_dir="/media/davide/DATA/data/voxgraph_local_planner/NoDrift/Maze"		# Can reuse same dir to add experiments
...
do  
  ...
  roslaunch active_3d_planning_app_submap_exploration voxgraph_local_planner.launch data_directory:=$target_dir record_data:=true data_frequency:=$freq time_limit:=$dur
