...
# *** Args (need to be set) ***
n_experiments=5
target_dir="/media/davide/DATA/data/voxblox_planner/Test_1"		# Can reuse same dir to add experiments
clear_voxblox_maps=false		# Irreversibly remove maps after evaluation to save disk space
